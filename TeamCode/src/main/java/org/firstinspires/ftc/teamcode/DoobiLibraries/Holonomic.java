...
public class Holonomic {
    ...
    public static double[] calcPowerTele(double face, double rotationPower, double X, double Y) {
        ...
        double x_comp = Y*Math.sin(face) + X*Math.cos(face);
        double y_comp = Y*Math.cos(face) - X*Math.sin(face);
        double rot_comp = rotationPower;
        motorPower[0] = y_comp + x_comp + rot_comp;
        motorPower[1] = y_comp - x_comp - rot_comp;
        motorPower[2] = y_comp - x_comp + rot_comp;
        motorPower[3] = y_comp + x_comp - rot_comp;
